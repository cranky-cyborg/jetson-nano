...
sudo apt remove -y gpicview xterm transmission-common simple-scan shotwell system-config-printer deja-dup rhythmbox lxterminal vim gnome-todo unity-lens-photos yelp onboard gnome-screenshot xserver-xorg-input-wacom gnome-online-accounts evolution-data-server 
